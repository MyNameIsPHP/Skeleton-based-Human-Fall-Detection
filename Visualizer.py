...
def plot_confusion_matrix(y_true, y_pred, labels=None, title='', normalize=None,
    ...
    disp.plot(cmap='Blues')  # Set the colormap to 'Blues' for a better visual effect
    disp.ax_.set_title(title, fontsize=20)  # Increase the font size of the title
    disp.ax_.set_xlabel('Predicted label', fontsize=15)  # Increase the font size of the x-axis label
    disp.ax_.set_ylabel('True label', fontsize=15)  # Increase the font size of the y-axis label
    disp.figure_.set_size_inches(fig_size)
    disp.figure_.tight_layout()

    # Modify the code to show numbers instead of percentages
    disp.im_.colorbar.remove()  # Remove the colorbar
