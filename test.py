...
if __name__ == '__main__':
    ...
    par.add_argument('-C', '--csv_file', default="UR_FallDetection/urfall-cam0-falls.csv",
                        help='Path to the CSV file containing fall detection data.')
    ...
    # Actions Estimate.
    action_model = TSSTG(weight_file=FALL_DETECT_WEIGHT_FILE)
