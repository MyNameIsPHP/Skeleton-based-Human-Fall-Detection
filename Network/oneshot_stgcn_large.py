...
class StreamSpatialTemporalGraph(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.osa_block_0(x, self.A, self.edge_importance[1:4])
        x = self.osa_block_1(x, self.A, self.edge_importance[4:9])
        # x = self.osa_block_2(x, self.A, self.edge_importance[5:7])
...
class OSA_STGCN_large_1S(nn.Module):
    def __init__(self, num_class, graph_args, edge_importance_weighting=True, **kwargs):
        ...
        self.st_gcn = StreamSpatialTemporalGraph(in_channels= 3, 
                                                ...
                                                **kwargs)
        self.fcn = nn.Linear(768, num_class)
...
class OSA_STGCN_large_2S(nn.Module):
    def __init__(self, num_class, graph_args, edge_importance_weighting=True,
        ...
        self.fcn = nn.Linear(864, num_class)
